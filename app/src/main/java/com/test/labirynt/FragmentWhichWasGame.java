...
public class FragmentWhichWasGame extends Fragment implements  SensorEventListener {
    View view;
...
//        textView10.setText("Bottom" + walls.get(0).getBottom());
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mySM.registerListener(FragmentWhichWasGame.this, sensor, SensorManager.SENSOR_DELAY_NORMAL);
